...
def calculate_perimeter(grid, region):
    ...
    for row, col in region:
        for dr, dc in [(0, 1), (1, 0), (0, -1), (-1, 0)]:
            ...
            if not (0 <= new_row < len(grid) and 0 <= new_col < len(grid[0])) or \
...
print(f"part1: {solve_part(grid, calculate_perimeter)}")
print(f"part2: {solve_part(grid, count_sides)}")
